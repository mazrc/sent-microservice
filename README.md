# Sentiment Analysis Spring Microservice

The Microservice:

- run on a docker container
- calls sentiment analysis python service (in another repo)
- logs on console and exposes metrics for prometheus

## Packaging the application
` $ mvn install`

## Running the application
` $ java -jar sent-service-0.0.1-SNAPSHOT.jar --sa.logic.api.url=http://localhost:5000 ` 
...
``` 
$ docker run -d -p 8080:8080 -e SA_LOGIC_API_URL='http://<container_ip or docker machine ip>:5000' $DOCKER_USER_ID/sent-service  
```
